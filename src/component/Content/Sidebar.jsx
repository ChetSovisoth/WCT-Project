    ...
    <div className="ms-3 mt-2 sticky-top">
      <div className="d-flex flex-column align-items-center">
        ...
        <div className="container p-3 d-flex justify-content-center align-items-center flex-column">
          ...
          <a className="btn btn-outline-black border-3 border-black mb-2" href={api[language].accomadation} style={{width: "288px"}} target="_blank" rel="noopener noreferrer">Accomadations</a>
        </div>
      </div>
    </div>
  )
