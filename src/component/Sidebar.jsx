  ...
  return (
    <div className="ms-3">
      <iframe
        ...
        className="shadow bg-body-tertiary rounded ms-2"
      ></iframe>
      ...
      <div className="d-flex flex-column align-items-center">
        ...
        <div className="container p-3">
          <a className="btn btn-outline-black border-3 border-black w-100 mb-2" href={api[language].restaurant} target="_blank" rel="noopener noreferrer">Restaurants</a>
          <a className="btn btn-outline-black border-3 border-black w-100 mb-2" href={api[language].accomadation}>Accomadations</a>
        </div>
      </div>
    </div>
  )
