  ...
  return (
    <div id="footer" className="bg-footer mb-0">
        <div className="row text-white mx-2 mb-3">
            ...
            <div className="col-4">
                <h3 className="py-3 ms-3">{language === 'English' ? "Follow Us": "តាម​ដានយើង"}</h3>
                ...
                <a href="https://www.instagram.com/cs.soth/" target="_blank" rel="noopener noreferrer"><i className="bi bi-instagram mx-3 fs-2 text-white"></i></a>         
