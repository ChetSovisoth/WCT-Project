...
import { setAuthLogout } from "../../Redux/authSlice.js";
    ...
    <>
      <nav className="navbar navbar-expand-lg bg-body-tertiary fixed-top">
        <div className="container-fluid">
          <Link className="navbar-brand mx-5 fw-bold fs-3" to="/">
            KomsanHub
          </Link>
          <button
            ...
            <ul className="navbar-nav flex-grow-1 justify-content-end align-items-center">
              <li className="nav-item mx-2">
                <Link to="/" className="nav-link">
                  {language === "English" ? "Home" : "ទំព័រដើម"}
                </Link>
              </li>
              <li className="nav-item mx-2">
                <Link to="/about" className="nav-link">
                  {language === "English" ? "About Us" : "អំពី​ពួក​យើង​"}
                </Link>
              </li>
              <li className="nav-item mx-2">
                <Link to="/contact" className="nav-link">
                  {language === "English" ? "Contact Us" : "ទាក់ទងយើង​"}
                </Link>
              </li>
              <li className="nav-item mx-2">
                <Link to="/bookmark" className="nav-link">
                  {language === "English" ? "Bookmarks" : "កំណត់ចំណាំ"}
                </Link>
              </li>
              ...
              <li className="nav-link mx-2 d-none d-lg-inline">
                ...
                >
                  ...
                  <span id="language-text">
                    {language === "English" ? "English" : "ខ្មែរ"}
                  </span>
                </button>
              </li>
              {/* small screen */}
              ...
              <li className="nav-link  mx-2">
                <Link
                  to={isAuthenticated ? "/signup" : "/signin"}
                  className="nav-link"
                >
                  {isAuthenticated ? (
                    <button
                    ...
                    >
                      {language === "English" ? "Logout" : "ចេញ"}
                    </button>
                  ) : (
                    <span>
                      {language === "English" ? "Sign In" : "ចូលគណនី"}
                    </span>
                  )}
                </Link>
              </li>
